...
function ManageEvent() {
    ...
    function handleSubmit(event) {
        ...
        if (!eventName || !eventDate || !eventStartTime || !eventDuration || !eventDescription || images.length == 0) {
    ...
    return (
        <div className="manageEvent">
            ...
            <form className="manageEvent--form">
                ...
                <select id="eventLocation" name="eventLocation" value={eventLocation} onChange={(e) => setEventLocation(e.target.value)}>
                ...
                <div className="check">
                    <Checkbox label="Event is paid" value={isEventPaid} onChange={handleCheck} />
                </div>
                ...
                <div className="imageUpload">
                    <ImageUploading multiple value={images} onChange={onChangeImage} maxNumber={maxNumber} dataURLKey="photoURL">
                ...
                {isLoading ? (
                    <FontAwesomeIcon icon={faSpinner} className="iconLoadingEventManage" />
                ) : (
