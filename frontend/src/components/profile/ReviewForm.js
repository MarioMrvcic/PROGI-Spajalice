...
import { faStar, faUser, faCalendarWeek } from '@fortawesome/free-solid-svg-icons'
        ...
        <div className="reviewPopup">
            <form className="reviewForm">
                <div className="reviewTitleDiv1">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <p className="locationDate">{new Date(props.eventData.eventDate).toISOString().split('T')[0]}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="reviewRatingDiv">
                    ...
                    <FontAwesomeIcon icon={faStar} className={`star1 ${rating >= 1 ? 'active' : ''}`} onClick={() => handleStarClick(1)} />
                    <FontAwesomeIcon icon={faStar} className={`star2 ${rating >= 2 ? 'active' : ''}`} onClick={() => handleStarClick(2)} />
                    <FontAwesomeIcon icon={faStar} className={`star3 ${rating >= 3 ? 'active' : ''}`} onClick={() => handleStarClick(3)} />
                    <FontAwesomeIcon icon={faStar} className={`star4 ${rating >= 4 ? 'active' : ''}`} onClick={() => handleStarClick(4)} />
                    <FontAwesomeIcon icon={faStar} className={`star5 ${rating >= 5 ? 'active' : ''}`} onClick={() => handleStarClick(5)} />
                </div>
