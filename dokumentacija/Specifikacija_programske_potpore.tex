			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\begin{packed_item}
						...
						\item  \textbf{Sudionici:} Baza podataka
						\item  \textbf{Preduvjet:} posjetitelj je prijavljen, otvoren je pregled događanja
						\item  \textbf{Opis osnovnog tijeka:}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_item}
								...
								\item posjetitelj je prijavljen, otvoren je pregled događanja
					...
					\begin{packed_item}
						...
						\item  \textbf{Sudionici:} Baza podataka
						\item  \textbf{Preduvjet:} otvoren je pregled događanja
						\item  \textbf{Opis osnovnog tijeka:}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item prikaz filtriranog prelgeda
					...
					\noindent \underbar{\textbf{UC14 -Stvaranje događanja}}
					\begin{packed_item}
					...
					\begin{packed_item}
						...
						\item  \textbf{Sudionici:} Baza podataka
						\item  \textbf{Preduvjet:} administrator je prijavljen, otvoren je pregled svih korisnika
						\item  \textbf{Opis osnovnog tijeka:}
