	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item odabir filtera koji se žele primjeniti
					...
					\noindent \underbar{\textbf{UC11 -Prijava na obavjesti}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC13 -Obavjest o nadolazećem događanju}}
					\begin{packed_item}
				...
				\subsubsection{Dijagrami obrazaca uporabe}
					...
					\begin{figure}[H]
						\includegraphics[scale=0.6]{slike/UC_dijagram1-1.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
						\centering
					...
					\begin{figure}[H]
						\includegraphics[scale=0.6]{slike/UC_dijagram2-1.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
						\centering
						\caption{Dijagram obrasca uporabe, funkcionalnost korisnika i posjetitelja}
						\label{fig:promjene}
					\end{figure}
			...
			\subsection{Sekvencijski dijagrami}
				...
				\begin{figure}[H]
						\includegraphics[scale=0.7]{slike/sek_dijagram1-1.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
						\centering
				...
				\begin{figure}[H]
						\includegraphics[scale=0.7]{slike/sek_dijagram2-1.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
						\centering
				...
				\begin{figure}[H]
						\includegraphics[scale=0.7]{slike/sek_dijagram3-1.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
						\centering
				...
				\begin{figure}[H]
						\includegraphics[scale=0.7]{slike/sek_dijagram4-1.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
						\centering
