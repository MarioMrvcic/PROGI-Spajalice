	...
	\section{Funkcionalni zahtjevi}
		...
		%	\textit{Navesti \textbf{dionike} koji imaju \textbf{interes u ovom sustavu} ili  \textbf{su nositelji odgovornosti}. To su prije svega korisnici, ali i administratori sustava, naručitelji, razvojni tim.}\\
			...
			\subsection{Sekvencijski dijagrami}
				...
				\begin{figure}[H]
						\includegraphics[scale=0.7]{slike/uc2-1.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
						\centering
				...
				\begin{figure}[H]
						\includegraphics[scale=0.7]{slike/uc5-1.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
						\centering
				...
				\begin{figure}[H]
						\includegraphics[scale=0.7]{slike/uc14-1.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
						\centering
				...
				\begin{figure}[H]
						\includegraphics[scale=0.7]{slike/uc20-1.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
						\centering
